...
function toggleModuleExpansion(moduleToggler) {
    ...
    let moduleContent = moduleToggler.parent('header').next('.content');
 ...
 */
const navigationToggler = $('#primary-navigation header i.toggler');

/**
 * The content of the primary navigation.
 */
const navigationContent = navigationToggler.parent().next('ul');
 ...
 * breakpoint.
 * @return {Boolean} if the media has the minimum width of a tablet.
 */
 ...
 * computer breakpoint.
 * @return {Boolean} if the media has the minimum width of a desktop computer.
 */
...
function windowPopup(url, width, height) {
  ...
  /**
   * Event handler for click events on social share pop-up anchors.
   */
