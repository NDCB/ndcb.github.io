...
class Category {
     ...
     * @prop {Website} category.website the website featuring this category.
     * @prop {string} category.headline the headline of the category.
     * @prop {string} category.slug the slug of the category.
     * @prop {string[]} category.path the path of the category.
     * @prop {string} category.themeColor the color the the category's theme.
     * @prop {string} category.thumbnailPath the absolute path of the
    ...
    /**
     * Determines whether or not a given path is part of this category.
     * @param {string[]} path the path to check.
     * @return {Boolean} {@code true} if the given path is part of this
     * category.
     */
    contains(path) {
