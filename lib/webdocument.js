...
class WebDocument {
     ...
     * @prop {Website} webDocument.website the website featuring this web
     * document.
     * @prop {string} webDocument.headline the headline of the web document.
     * @prop {string} webDocument.description the description of the web
     * document.
     * @prop {string[]} webDocument.path the path of the web document.
     * @prop {string} webDocument.changeFrequency the change frequency of the
     * web document.
     * @prop {number} webDocument.priority the priority of the web document.
     * @prop {string[]} webDocument.plugins the array of plugins used for this
     * web document.
     */
    constructor({
        website,
    ...
    /**
     * @return {Figure[]} the figures featured in this web document.
     */
    get figures() {
        let figures = [];
        let categoryFigures = this.category.figures;
        for (let figure of categoryFigures) {
